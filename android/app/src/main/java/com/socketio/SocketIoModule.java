...
public class SocketIoModule extends ReactContextBaseJavaModule {
    ...
    public void emit(String event, ReadableMap items) {
        ...
        emitMsg(event, new JSONObject(map));
    }
    @ReactMethod
    public void emit(String event, ReadableArray msg) {
        emitMsg(event, msg);
    }
     ...
     * Emit event to server
     * @param event The name of the event.
     * @param msg The data to pass through the SocketIo engine to the server endpoint.
     */
    @ReactMethod
...
//    @ReactMethod
//    public void emit(String event, Integer msg) {
//        emitMsg(event, msg);
//    }
//    @ReactMethod
//    public void emit(String event, Double msg) {
//        emitMsg(event, msg);
//    }
//    @ReactMethod
//    public void emit(String event, Boolean msg) {
//        emitMsg(event, msg);
//    }

    private void emitMsg(String event, Object... msgs){
        if (mSocket != null) {
            mSocket.emit(event, msgs);
        }
        else {
    ...
    private Emitter.Listener onAnyEventHandler (final String event) {
        ...
        return new Emitter.Listener() {
            ...
            public void call(Object... args) {
                ...
                for(Object obj : args){
                    Log.w(TAG, "onAnyEventHandler call obj: " + obj);
                }
